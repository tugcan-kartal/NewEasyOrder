    ...
    <div>
        ...
        <div className='flex md:flex-row flex-col justify-center items-center gap-x-[5vw] gap-y-[5vh] pt-[15vh]'>
            ...
            <div className='md:w-[40vw] w-[90vw] flex flex-col justify-center gap-y-[2vh]'>
                <div className='text-red-600 text-4xl font-bold'>{t("Full Service by SambaPOS -fullservice")}</div>
                <div className='text-xl font-bold'>{t("SambaPOS – the Full Service Restaurant POS that synchronizes software with restaurant service -fullservice")}</div>
                <div>
                    {t("Your restaurant needs to deliver a complete and satisfying dining experience to your customers. With SambaPOS, you can do that and more. Orders, payments, kitchen management, performance analysis – we have solutions for them all. Streamline your operations and provide your guests with a memorable meal. -fullservice")}
                </div>
            </div>
        ...
        <div className='flex md:flex-row flex-col justify-center items-center gap-x-[5vw] gap-y-[5vh] py-[10vh]'>
            ...
            <div className='md:w-[40vw] w-[90vw] flex flex-col justify-center gap-y-[2vh] md:order-1'>
                <div className='text-red-600 text-4xl font-bold'>{t("Full Service -fullservice")}</div>
                <div className='text-xl font-bold'>{t("SambaPOS – Complete Solution for Full Service Restaurants -fullservice")}</div>
                <div>
                    {t("Transform your orders, kitchen, payments, inventory, and more with SambaPOS today. Delight your customers with flawless service. Buy SambaPOS or become a partner today! -fullservice")}
                </div>
            </div>
        ...
        <div className='relative'>
            ...
            <div className='flex flex-col gap-y-[5vh] z-10 absolute top-[10vh] left-5'>
                ...
                <div>
                    <div className='text-red-600 text-2xl font-bold'>{t("Make it omnichannel -fullservice")}</div>
                    <div className='text-4xl font-bold text-gray-800'>{t("Discover our ecosystem -fullservice")}</div>
                </div>
