...
import FullServiceImage from '../../../static/fullservice-solutions.png';
import FullServiceImage2 from '../../../static/fullservice2-solutions.png';
    ...
    <div>
        ...
        <div className='flex md:flex-row flex-col justify-center items-center gap-x-[5vw] gap-y-[5vh] pt-[15vh]'>
            ...
            <div className='md:w-[40vw] w-[90vw] flex flex-col justify-center gap-y-[2vh]'>
                <div className='text-red-600 text-4xl font-bold'>Full Service by SambaPOS</div>
                <div className='text-xl font-bold'>SambaPOS – the Full Service Restaurant POS that synchronizes software with restaurant service</div>
                <div>
                    Your restaurant needs to deliver a complete and satisfying dining experience to your customers. 
                    With SambaPOS, you can do that and more. Orders, payments, kitchen management, performance analysis – 
                    we have solutions for them all. Streamline your operations and provide your guests with a memorable meal.
                </div>
            </div>

            <div>
                <div>
                    <img className='md:w-[40vw] w-[90vw]' src={FullServiceImage} alt="Fine Dining" />
                </div>
            </div>
        ...
        <div className='flex md:flex-row flex-col justify-center items-center gap-x-[5vw] gap-y-[5vh] py-[10vh]'>
            ...
            <div className='md:w-[40vw] w-[90vw] flex flex-col justify-center gap-y-[2vh] md:order-1'>
                <div className='text-red-600 text-4xl font-bold'>Full Service</div>
                <div className='text-xl font-bold'>SambaPOS – Complete Solution for Full Service Restaurants</div>
                <div>
                    Transform your orders, kitchen, payments, inventory, and more with SambaPOS today. 
                    Delight your customers with flawless service. Buy SambaPOS or become a partner today!
                </div>
            </div>

            <div>
                <div>
                    <img className='md:w-[40vw] w-[90vw]' src={FullServiceImage2} alt="Fine Dining" />
                </div>
            </div>
