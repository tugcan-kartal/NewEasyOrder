...
import PaymentsenseImage from "../../../static/paymentsense.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='text-xl text-blue-900 font-semibold'>
                        Streamline the Payment Methods at Your Restaurant with SambaPOS PaymentSense Integratio
                    </div>

                    <div className='font-thin text-blue-900'>
                        With SambaPOS PaymentSense Integration, you can accept payments remotely or in-person. You can also manage your transactions with the intuitive features of the SambaPOS dashboard.
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={PaymentsenseImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        SambaPOS PaymentSense Integration                    
                    </div>

                    <div>
                        Bill sharing with the customer becomes easier and can be accessed via SambaPOS <br />
                        The secure card machine reduces chances of human error <br />
                        Regulations are followed as per the law  <br />
                        Customer data and income data is securely stored and processed <br />
                        The SambaPOS PaymentSense Integration is easy to use, configure, and manage <br />
                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>Payment Sense</span>
