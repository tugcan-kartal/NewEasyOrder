...
import SambaPosNeptuneImage from "../../../static/sambaposneptune.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='text-xl text-blue-900 font-semibold'>
                        The hospitality sector is often considered one of the exhilarating businesses to be in today. However, the increase in technological integration in this business also increases the complexity and speed with which outcomes need to be delivered.
                    </div>

                    <div className='font-thin text-blue-900'>
                        While the experience may be daunting, restaurant owners turn to Point of Sale (POS) systems to monitor inventory, process payments and analyze revenue. With the help of robust systems and software, restaurateurs can efficiently manage employees, accept online orders, and boost profits.
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={SambaPosNeptuneImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        SambaPOS Neptune, the rapid application development platform, helps provide central branch management with its extensive functionalities.
                    </div>

                    <div>
                        Thanks to the presence of multiple franchises, chains and branches, restaurant owners are looking to deploy a multi-location setup on a cloud server.
                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>SambaPOS Neptune</span>
                        </div>

                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>Web based branch management system</div>
                            <div>Integrated with SambaPOS V5 Pro</div>
                            <div>Managing branches in separate groups</div>
                            <div>Automated sync feature</div>
                            <div>Branch order tracking system</div>
                            <button className='mx-auto bg-blue-900 text-white py-[1vh] px-[2vw] mt-[2vh] rounded-lg hover:bg-blue-500 hover:text-white'>Enterprise Product</button>
                        </div>
...
export default SambaPOSneptune;
