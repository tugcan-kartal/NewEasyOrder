...
import SambaPosAndroidImage from "../../../static/sambaposandroid.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='font-thin text-blue-900'>
                        Order Management → Faster Service <br />
                        Personalized Customer Experience → Improved Customer Satisfaction <br />
                        Increased Staff Efficiency → Fewer Errors <br />
                        Growing Customer Base → Effective Marketing Campaigns 
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={SambaPosAndroidImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        For accelerated business growth, the restaurants need a streamlined ordering system
                    </div>

                    <div>
                        allowing them to effortlessly deliver exceptional service to the customers.
                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>SambaPOS Android CID</span>
                            <span className='text-3xl font-semibold'>$19</span>
                            <span>One off / Per Device</span>
                        </div>

                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>Turns your android phone to a Caller ID device</div>
                            <div>Requires Android 5.0 and higher</div>
                            <div>Multiple phone support</div>
...
export default SambaPOSandroid;
