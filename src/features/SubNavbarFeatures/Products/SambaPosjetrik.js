...
import SambaPosJetrikImage from "../../../static/sambaposjetrik.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='text-xl text-blue-900 font-semibold'>
                        The world has rapidly adopted digital technology, and its presence can be felt everywhere you go, even while placing an order at a restaurant.
                    </div>

                    <div className='font-thin text-blue-900'>
                        Jetrik QR Menu is specifically designed to assist you to serve your customers better by removing the old system of print menus and chalkboards. With Jetrik QR Menu, customers visiting your restaurant can easily place an order using the digital menu, allowing you to update the menu and pricing seamlessly.
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={SambaPosJetrikImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        Easily Manage And Update Your Menu On The Go
                    </div>

                    <div>
                        Stunning In-Built Themes To Impress Your Customers
                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>Jetrik QR Menu</span>
                        ...
                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>For Unlimited Tables & Customers</div>
                            <div>Add Unlimited Products, Deals, and More</div>
