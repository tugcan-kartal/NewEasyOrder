...
import SambaPosTabletImage from "../../../static/sambapostablet.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='font-thin text-blue-900'>
                        — Integrated with latest SambaPOS V5 & Menu and Product Integration & Android and iOS Versions & Multi-language Support & Managed from Web
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={SambaPosTabletImage} alt='not found' />
                </div>
            </div>
        ...
        <div>
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    ...
                    <div>
                        Compatible with Android and iOS & Easy Monitoring and Updating
                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>SambaPOS GO Tablet</span>
                        ...
                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>Fully integrated with SambaPOS V5</div>
                            <div>Menu and Product Synchronization</div>
                            <div>Multi-language Support</div>
                            <div>Android - IOS Support</div>
                            <div>Use with 3 Methods</div>
                            <div>Manage from Web</div>
                            <div>-</div>
