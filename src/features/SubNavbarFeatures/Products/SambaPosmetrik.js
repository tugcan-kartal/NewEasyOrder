...
import SambaPOSMetrikImage from "../../../static/sambaposmetrik.png";
        ...
        <div>
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='flex flex-row gap-x-[1vw]'>
                        ...
                        <button className='bg-blue-900 text-white p-4 rounded-full hover:bg-blue-800 transition-all duration-300'>How to Install</button>
                    </div>

                </div>

                <div>
                    <img className='md:w-[20vw]' src={SambaPOSMetrikImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex md:flex-row flex-col gap-x-[10vw] gap-y-[5vh] mt-[10vh] mx-[5vw]'>
                <div className='flex flex-col gap-y-[4vh] bg-white text-blue-900 rounded-xl md:w-[20vw] w-[90vw] py-[3vh] text-center'>
                    <div className='font-bold'>Basic $59</div>
                    <div className='font-bold'>1 restaurant and 1 users</div>
                    <div className='border-[1px] border-blue-900 md:w-[10vw] w-[40vw] rounded-2xl py-[1vh] mx-auto hover:bg-blue-900 hover:text-white transition-all duration-500 cursor-pointer'><span className='font-bold'>+</span> Buy Now</div>
                </div>

                <div className='flex flex-col gap-y-[4vh] bg-white text-blue-900 rounded-xl md:w-[20vw] w-[90vw] py-[3vh] text-center'>
                    <div className='font-bold'>Standart $99</div>
                    <div className='font-bold'>1 restaurant and 3 users</div>
                    <div className='border-[1px] border-blue-900 md:w-[10vw] w-[40vw] rounded-2xl py-[1vh] mx-auto hover:bg-blue-900 hover:text-white transition-all duration-500 cursor-pointer'><span className='font-bold'>+</span> Buy Now</div>
                </div>

                <div className='flex flex-col gap-y-[4vh] bg-white text-blue-900 rounded-xl md:w-[20vw] w-[90vw] py-[3vh] text-center'>
                <div className='font-bold'>Premium $149</div>
                    <div className='font-bold'><div className='font-bold'>1 restaurant and unlimited users</div></div>
                    <div className='border-[1px] border-blue-900 md:w-[10vw] w-[40vw] rounded-2xl py-[1vh] mx-auto hover:bg-blue-900 hover:text-white transition-all duration-500 cursor-pointer'><span className='font-bold'>+</span> Buy Now</div>
                </div>
            </div>
        </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        SambaPOS Metrik Real-time tracking metrics for restaurants.
                    </div>

                    <div>
                        A high-performing restaurant tracking app, metriK For SambaPOS is specifically designed to give you access to all the essential performance tracking metrics directly on your smartphone instantly.                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>SambaPOS V5 Metrik (Standart) </span>
