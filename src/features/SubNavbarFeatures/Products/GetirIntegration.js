...
import GetirIntegrationImage from "../../../static/getirintegration.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='text-xl text-blue-900 font-semibold'>
                        Receive and deliver more orders now with SambaPOS Getir Integration.
                    </div>

                    <div className='font-thin text-blue-900'>
                        Keep your business flexible, and accept orders from Getir. SambaPOS integration with Getir ensures that your business is equipped to handle a large number of incoming orders from Getir.
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={GetirIntegrationImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        SambaPOS Getir Integration         
                    </div>

                    <div>
                        Here’s why restaurants choose SambaPOS Getir Integration
                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>SambaPOS Getir Integration</span>
                        </div>

                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>Receive orders quickly, easily, and directly from Getir to your POS without any downtime</div>
                            <div>Experience a seamless and automated order flow management</div>
                            <div>Easy-to-use and centralized platform to handle, process, and monitor the orders received from Getir</div>
                            <div>Reduce input errors and keep all your order-related data in one place</div>
                            <div>Organized system to track your orders, sales, and keep track of every item that leaves your restaurant</div>
                            <div>Manage your insights that create an impact on your business</div>
                        </div>
...
export default GetirIntegration;
