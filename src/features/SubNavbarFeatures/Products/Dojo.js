...
import DojoImage from "../../../static/dojo.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='text-xl text-blue-900 font-semibold'>
                        Simplify the Payment Methods of Your Restaurant with SambaPOS Dojo Integration
                    </div>

                    <div className='font-thin text-blue-900'>
                        SambaPOS has organized the SambaPOS Dojo Integration for your convenience. By integrating your Dojo card machine with SambaPOS, you can access all transactions in one dashboard that can be configured as per your brand and organization.
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={DojoImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        Features of Dojo Card Machines
                    </div>

                    <div>
                        Designed for seamless payments & End-to-end encryption & Uninterrupted connection
                    </div>
                </div>
