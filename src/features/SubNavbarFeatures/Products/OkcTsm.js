...
import OkcTsmImage from "../../../static/okctsm.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='text-xl text-blue-900 font-semibold'>
                        Avail of the best payment process solution for your business.
                    </div>

                    <div className='font-thin text-blue-900'>
                        Your restaurant can have faster and safer wireless transactions with the SambaPOS ÖKC for Ingenico TSM integration.
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={OkcTsmImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        Cloud Payment Process
                    </div>

                    <div>
                        Your restaurant needs a secure payment system to function seamlessly. The SambaPOS ÖKC for Ingenico TSM integration allows your customers to pay at the tableside or takeaway with the assistance of ÖKC devices connected over the cloud. The transaction instantly generates the receipts and reports the payment safely.
                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>Ingenico TSM Integration</span>
                            <span className='text-3xl font-semibold'>$199 +VAT</span>
                            <span>Yearly</span>
                        </div>

                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>Print and view ticket contents</div>
                            <div>Tableside and takeaway payment</div>
                            <div>Quick and secure</div>
                            <div>SambaPOS V5 Pro License Mandatory</div>
