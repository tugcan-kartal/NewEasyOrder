...
import RegulationTIMSImage from "../../../static/regulationtims.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    <div className='md:text-5xl text-3xl text-red-600 font-bold'>
                        Regulation TIMS for Samoa
                    </div>

                    <div className='text-xl text-blue-900 font-semibold'>
                        If you run a restaurant business in Samoa, you can avail of the SambaPOS integration with TIMS for Samoa and become an official record processor.
                    </div>

                    <div className='font-thin text-blue-900'>
                    The Tax Invoice Monitoring System (or TIMS) is part of the official regulations set by the Samoan Ministry of Finance. Record all your sales and transactions as per the rules!</div>
                    </div>

                    <div>
                        <img className='md:w-[30vw]' src={RegulationTIMSImage} alt='not found' />
                    </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        Efficient Payment Methods with tRegulation TIMS for Samoa
                    </div>

                    <div>
                        The integration with SambaPOS offers you the best payment solutions for your restaurant. Your customers can choose their mode of payment – cash, credit or debit card, etc. – and record it with TIMS.
                    </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>TIMS for Samoa Integration</span>
                        </div>
