...
import GloriaFoodIntegrationImage from "../../../static/gloriafoodintegration.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='text-xl text-blue-900 font-semibold'>
                        Unlock the potential of automation and power your restaurant with the ability to handle order volume surges. SambaPOS integrates with GloriaFood™
                    </div>

                    <div className='font-thin text-blue-900'>
                        helps boost your sales and provides you with remarkable opportunities to stay ahead of the curve.
                    </div>
                </div>

                <div>
                    <img className='md:w-[30vw]' src={GloriaFoodIntegrationImage} alt='not found' />
                </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        SambaPOS GloriaFood Integration
                    </div>

                    <div>
                        Benefits to using SambaPOS GloriaFood Integration
                    </div>
                </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>SambaPOS GloriaFood Integration</span>
                        ...
                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>Website and Application Integration</div>
                            <div>Collect All Relevant Order Details</div>
                            <div>Insightful Reports for Data Analysis</div>
                            <div>-</div>
...
export default GloriaFoodIntegration;
