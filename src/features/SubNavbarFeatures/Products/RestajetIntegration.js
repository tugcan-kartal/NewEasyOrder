...
import RestajetIntegrationImage from "../../../static/restajetintegration.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    <div className='md:text-5xl text-3xl text-red-600 font-bold'>
                        RestaJet Integration for Your Restaurant Business
                    </div>

                    <div className='text-xl text-blue-900 font-semibold'>
                        SambaPOS is widely known to offer various innovations and features that make the ordering and dining experience more systematic and convenient for customers. 
                    </div>

                    <div className='font-thin text-blue-900'>
                        It assists to reduce considerable manual efforts, leaving you with more time to develop smart business strategies. With the SambaPOS RestaJet integration, you can derive added benefits that will help your restaurant generate more sales. You will see day by day how you can increase your orders and customer base.                    </div>
                    </div>

                    <div>
                        <img className='md:w-[30vw]' src={RestajetIntegrationImage} alt='not found' />
                    </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    <div className='text-blue-800 font-bold text-3xl'>
                        About RestaJet Integration                    
                    </div>

                    <div>
                        Restaurants can integrate their SambaPOS with RestaJet – one of the most popular online ordering platforms. Make use of SambaPOS RestaJet integration to market and promote your business to a wider audience.
                    </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>RestaJet Integration</span>
                        ...
                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>For website and application both</div>
                            <div>Insightful reports and data analytics</div>
                            <div>-</div>
...
export default RestajetIntegration;
