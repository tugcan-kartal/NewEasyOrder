...
import TakeawayIntegrationImage from "../../../static/takeawayintegration.png";
            ...
            <div className='flex md:flex-row flex-col justify-center items-center gap-x-[10vw] gap-y-[10vh] px-[10vw]'>
                <div className='md:w-[40vw] flex flex-col gap-y-[3vh]'>
                    ...
                    <div className='text-xl text-blue-900 font-semibold'>
                        SambaPOS enables your restaurant to extend its reach by integrating JustEat.
                    </div>

                    <div className='font-thin text-blue-900'>
                        In a competitive market like the food industry, finding that one edge will take you above all the other restaurants is imperative. Also, you must provide the best and the most convenient experience for your customers. This is what SambaPOS offers with its integration with JustEat Takeaway.</div>
                    </div>

                    <div>
                        <img className='md:w-[30vw]' src={TakeawayIntegrationImage} alt='not found' />
                    </div>
            </div>
        ...
        <div>
            <div className='flex flex-col md:flex-row md:justify-center items-center gap-x-[10vw] gap-y-[5vh] py-[10vh]'>
                ...
                <div className='w-[80vw] md:w-[35vw] flex flex-col justify-center gap-y-[5vh]'>
                    ...
                    <div>
                        Smooth Customer Service & Multi Payment Options & Simply lug and Play
                    </div>
                ...
                <div className='w-[80vw] md:w-[30vw]'>
                    <div>
                        <div className='bg-blue-900 text-white py-[2vh] flex flex-col items-center gap-y-[1vh]'>
                            <span className='text-xl font-bold'>Takeaway Integration</span>
                        ...
                        <div className='bg-white flex flex-col items-center gap-y-[2vh] py-[5vh] font-extralight text-center'>
                            <div>Automatic order transfer to SambaPOS</div>
                            <div>Order and packager tracking</div>
...
export default TakeawayIntegration;
